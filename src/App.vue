...
@font-face {
  font-family: Manchu;
  src: url(./assets/fonts/XM_XingShu.ttf);
}
...
:root {
  ...
  --bg-default: #3aafa9;
  --bg-dark: #2b7a78;
  --white-default: #feffff;
  --white-turqoise: #def2f1;
  --dark-default: #17252a;
  --dark-extra: #101b1e;
